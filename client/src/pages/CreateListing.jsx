...
const CreateListing = () => {
  ...
  const handlePost = async (e) => {
    ...
    try {
      ...
      listingForm.append("schoolCount", schoolCount);
      listingForm.append("collegeCount", collegeCount);
      listingForm.append("hospitalCount", hospitalCount);
            ...
            <div className="basics">
              ...
              <div className="basic">
                ...
                <div className="basic_count">
                  <RemoveCircleOutline
                    onClick={() => {
                      schoolCount > 1 && setSchoolCount(schoolCount - 1);
                    }}
                    sx={{
                      fontSize: "25px",
                      cursor: "pointer",
              ...
              <div className="basic">
                ...
                <div className="basic_count">
                  <RemoveCircleOutline
                    onClick={() => {
                      collegeCount > 1 && setCollegeCount(collegeCount - 1);
                    }}
                    sx={{
                      fontSize: "25px",
                      cursor: "pointer",
              ...
              <div className="basic">
                ...
                <div className="basic_count">
                  <RemoveCircleOutline
                    onClick={() => {
                      hospitalCount > 1 && setHospitalCount(hospitalCount - 1);
                    }}
                    sx={{
                      fontSize: "25px",
                      cursor: "pointer",
